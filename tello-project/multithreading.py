...
from img_process import door3, door2, door1
...
def videoplayer():
    ...
    while keepRecording:
        ...
        if order_list[0]==1:
            image1, cc_x,cc_y, flag, weight,height = door1(image1)
        elif order_list[0]==2:
            image1, cc_x,cc_y, flag, weight,height = door2(image1)
        elif order_list[0]==3:
            image1, cc_x,cc_y, flag, weight,height = door3(image1)
...
while True:
    ...
    if order_list[0]==1:
        ...
        img1,cc_xx1,cc_yy1, flag1, weight1,height1 = door1(img1)
        if flag1 ==1:
            cc_x1=cc_xx1
            cc_y1=cc_yy1
        print('flag1=',flag1)
    ...
    if order_list[0]==2:
        ...
        img2,cc_xx2,cc_yy2, flag2,weight2, height2 = door2(img2)
        if flag2 ==1:
            cc_x2=cc_xx2
            cc_y2=cc_yy2
        print('flag2=',flag2)
    ...
    if order_list[0]==3:
        ...
        img3,cc_xx3,cc_yy3, flag3,weight3, height3 = door3(img3)
        if flag3 ==1:
            cc_x3=cc_xx3
            cc_y3=cc_yy3
        print('flag3=',flag3)
